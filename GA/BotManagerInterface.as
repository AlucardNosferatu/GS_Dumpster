...
namespace BotManager
{
	...
	*/
	final class BotManager
	{
		...
		{
			bool recv=false;
			CBaseEntity@ EntRecv=g_EntityFuncs.FindEntityByTargetname(g_EntityFuncs.Instance(0),"AMXX_GA_SEND");
			if(EntRecv !is null)
			{
					g_EngineFuncs.ServerPrint("Detected Spawned Entity By AS.\n");
					this.test1=EntRecv.pev.fuser1;
					this.test2=EntRecv.pev.fuser2;
					this.test3=EntRecv.pev.fuser3;
					this.test4=EntRecv.pev.fuser4;
					g_EngineFuncs.ServerPrint(formatFloat(this.test1,"0",0,4)+" "+formatFloat(this.test2,"0",0,4)+" "+formatFloat(this.test3,"0",0,4)+" "+formatFloat(this.test4,"0",0,4)+" "+"\n");
					g_EntityFuncs.Remove(EntRecv);
					recv=true;
			}
			...
			if(recv)
			{
				...
				g_EntityFuncs.DispatchSpawn(EntSend.edict());
			}
		}
